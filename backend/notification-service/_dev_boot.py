...
SVC  = Path("C:/Users/USER PC/Desktop/velontri/notification-service").as_posix()
...
apply_patches("notification-service")

# Now import and run the service app via uvicorn
import uvicorn
uvicorn.run("app.main:app", host="0.0.0.0", port=8012, log_level="warning", reload=False)
