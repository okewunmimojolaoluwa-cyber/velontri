...
async def lifespan(app: FastAPI) -> Any:  # type: ignore[misc]
    ...
    try:
        ...
        async with engine.begin() as _conn:
            ...
            # Add retry_count to subscriptions if missing
            await _conn.execute(_text("ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS retry_count INTEGER NOT NULL DEFAULT 0"))
            await _conn.execute(_text("""
