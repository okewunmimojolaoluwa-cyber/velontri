...
<table width="100%" cellpadding="0" cellspacing="0" style="padding:48px 16px">
  <tr><td align="center">
    ...
    async def _send_welcome_email(self, email: str, full_name: str) -> None:
        """Send a polished welcome email after the user verifies their account."""
        import os
        first_name = full_name.split()[0] if full_name else 'there'
        brevo_key    = (getattr(self.settings, 'BREVO_API_KEY', '') or os.environ.get('BREVO_API_KEY', '')).strip()
        gmail_user   = (self.settings.GMAIL_USER or os.environ.get('GMAIL_USER', '')).strip()
        ...
        plain_body = (
            ...
            '  🛍️  Browse thousands of verified listings\n'
            '  📦  Post your own listings for free\n'
            '  💬  Connect with buyers & sellers instantly on WhatsApp\n'
            '  ✅  Get verified as a trusted seller\n\n'
            f'Start exploring now: {app_url}\n\n'
            f'Questions? Email us at support@velontri.pxxl.click\n\n'
            '— The Velontri Team 🌍'
        )
        html_body = f"""<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Welcome to Velontri</title>
</head>
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#f1f5f9;padding:40px 16px">
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
      style="max-width:560px;background:#ffffff;border-radius:24px;overflow:hidden;
             box-shadow:0 4px 32px rgba(0,0,0,0.08);border:1px solid #e2e8f0">
      ...
      <tr>
        <td style="background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 60%,#a855f7 100%);
          ...
          <div style="display:inline-block;background:rgba(255,255,255,0.18);
                      border-radius:14px;padding:10px 28px;margin-bottom:24px">
            <span style="color:#fff;font-size:26px;font-weight:900;letter-spacing:1px;
                         font-family:'Inter',Arial,sans-serif">Velontri</span>
          </div>
          <!-- Emoji confetti row -->
          ...
          <p style="color:rgba(255,255,255,0.75);font-size:14px;margin:0;line-height:1.5">
            Africa's fastest-growing marketplace just got better.
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:40px 40px 32px">
          ...
          <p style="font-size:14px;color:#64748b;line-height:1.8;margin:0 0 32px">
            Your account is <strong style="color:#10b981">fully verified and active</strong>.
            You've joined a growing community of buyers and sellers across 12 African countries.
            Here's everything you can do right now:
          </p>

          <!-- Feature list — clean card rows -->
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                 style="margin-bottom:32px;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden">
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    ...
                    <td style="vertical-align:middle;padding-left:12px">
                      <p style="color:#1e293b;font-size:13px;font-weight:700;margin:0 0 2px">
                        Browse Verified Listings
                      </p>
                      <p style="color:#94a3b8;font-size:12px;margin:0;line-height:1.5">
                        Thousands of products, properties, vehicles and services.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td style="padding:16px 18px;border-bottom:1px solid #f1f5f9;background:#fafafa">
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    ...
                    <td style="vertical-align:middle;padding-left:12px">
                      ...
                      <p style="color:#94a3b8;font-size:12px;margin:0;line-height:1.5">
                        Sell anything: cars, phones, fashion, services. No fees to start.
                      </p>
                    </td>
                  </tr>
                </table>
                ...
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    ...
                    <td style="vertical-align:middle;padding-left:12px">
                      ...
                      <p style="color:#94a3b8;font-size:12px;margin:0;line-height:1.5">
                        Every listing links you directly to the seller — zero friction.
                      </p>
                    </td>
                  </tr>
                </table>
                ...
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    ...
                    <td style="vertical-align:middle;padding-left:12px">
                      ...
                      <p style="color:#94a3b8;font-size:12px;margin:0;line-height:1.5">
                        Get the trusted badge and stand out to thousands of buyers.
                      </p>
                    </td>
                  </tr>
                </table>
              ...
              <td align="center">
                <a href="{app_url}/listings"
                   style="display:inline-block;
                          ...
                          border-radius:14px;padding:16px 44px;letter-spacing:0.3px;
          ...
          <div style="background:linear-gradient(135deg,#eff6ff,#f5f3ff);
                      border:1px solid #c7d2fe;border-radius:14px;padding:18px 20px;
                      margin-bottom:24px">
            <p style="font-size:13px;color:#3730a3;margin:0;line-height:1.8">
              <strong>You're early.</strong> Velontri is building something big for Africa,
              and you're part of the founding community. Every listing, every connection,
              every sale — it all helps us grow. Thank you for believing in us. 🌍
            </p>
          </div>
          ...
          <p style="font-size:13px;color:#94a3b8;margin:0;line-height:1.6;text-align:center">
            ...
            <a href="mailto:support@velontri.pxxl.click"
               style="color:#6366f1;text-decoration:none;font-weight:600">
              support@velontri.pxxl.click
            </a>
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="background:#f8fafc;padding:20px 40px;border-top:1px solid #e2e8f0;
          ...
          <p style="font-size:11px;color:#94a3b8;margin:0 0 4px">
            © 2025 Velontri · Africa's Premier Marketplace
          </p>
