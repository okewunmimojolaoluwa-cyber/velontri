...
export default function HomepageManagerPage() {
 ...
 After saving, visit the homepage to see your changes. All sections pull real listing data from the database  sections with no active listings show an empty state automatically.
 </p>
