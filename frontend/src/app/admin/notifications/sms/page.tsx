...
import { DeviceMobile, CaretRight } from '@phosphor-icons/react';
...
export default function SmsCampaignsPage() {
 ...
 <DeviceMobile className="h-6 w-6 text-indigo-600" /> SMS Campaigns
 </h1>
 ...
 <DeviceMobile className="h-5 w-5 text-indigo-600" />
 </div>
 <div>
